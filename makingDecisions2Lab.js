...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,1];
// Do not edit the code above.
...
// Use an if statement to check the length of the 'myFavoriteNumbers' array. If it's less than 7, log 'There are not enough 
//elements in this array' to the console. If the length is more than 7, 
//reassign the value of 'someNum' to the value of the 7th element in the array. (Hint: how can you make sure that your code 
//works for exactly 7 elements ? What index do you use to get the 7th element ?)
...
if (myFavoriteNumbers.length < 7) {
  ...
  myFavoriteNumbers.splice(6,0,someNum) //someNum=myFavoriteNumbers[6]
}
